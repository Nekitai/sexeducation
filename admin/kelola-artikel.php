...
if (isset($_GET['id']) && ($_GET['act'] == 'ubah' || $_GET['act'] == 'hapus')) {
    $sql = "SELECT * FROM tbl_artikel WHERE id = ?";
...
<form action="../action/kelola-artikel.php" method="POST" enctype="multipart/form-data" class="article-form">
...
<div class="mb-3 row">
    ...
    <div class="mb-3 row">
        ...
        <div class="col-sm-10">
            <textarea class="form-control" id="artikel" name="artikel" rows="10" cols="500" <?= $_GET['act'] == 'hapus' ? 'readonly' : '' ?>><?= @$row['artikel'] ?></textarea>
        </div>
    </div><br><br>

    <!-- Tombol -->
    <div class="offset-sm-2">
    <a href="/admin/index.php?page=artikel" class="btn btn-warning me-2">Kembali</a>
