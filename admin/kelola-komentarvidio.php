...
if (isset($_GET['id']) && ($_GET['act'] == 'ubah' || $_GET['act'] == 'hapus')) {
    $sql = "SELECT * FROM tbl_komentarvidio WHERE id = ?";
...
<figure class="text-center">
    <blockquote class="blockquote">
        <p>
            ...
            <?= ucwords($_GET['act'] == "ubah" ? "Ubah: {$row['artikel_id']}" : "") ?>
            <?= ucwords($_GET['act'] == "hapus" ? "Hapus: {$row['artikel_id']}" : "") ?>
            <span data-feather="minus"></span>
        </p>
    </blockquote>
</figure>

<form action="../action/kelola-komentarvidio.php" method="POST" enctype="multipart/form-data" class="article-form">
